...
const zh: Translations = {
  ...
  probTitle: '概率計算器',
  probDesc: '支援簡單概率、組合數概率及貝葉斯定理，自動展示完整推導步驟',
  modeSingle: '簡單概率',
  modeCombProb: '組合數概率',
  modeBayes: '貝葉斯定理',
  inputFav: '有利結果數',
...
const en: Translations = {
  ...
  probDesc: 'Supports simple probability, combination-based probability and Bayes theorem with full derivation steps',
  modeSingle: 'Simple Probability',
  modeCombProb: 'Combination Probability',
